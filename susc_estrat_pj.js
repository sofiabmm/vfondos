...
clientes.forEach(cliente => {
    ...
    let soli= 
        ...
        (async () => {
            ...
            // cuit
            await frame.click('#grdcboTpDocIdentidad_3 > td:nth-child(2)')
            ...
            // selecciona fondo
            // await page4.click('#grdcboTpValorCp_6 > td:nth-child(3)')
            // await page4.click('#grdcboTpValorCp_0 > td:nth-child(3)')
            // clase b
            await page4.click('#grdcboTpValorCp_7 > td:nth-child(3)')
